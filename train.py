...
def create_train_dataloader(opt, logger):
    ...
    Returns:
    tuple: Returns a tuple containing the train loader, train sampler, total epochs, and total iterations.
    """
...
def create_val_dataloader(opt, logger):
    ...
    Returns:
    list: Returns a list of validation loaders.
    """
...
def create_train_val_dataloader(opt, logger):
    ...
    Returns:
    tuple: Returns a tuple containing the train loader, train sampler, validation loaders, total epochs, and total iterations.
    """
...
def load_resume_state(opt):
    ...
    if resume_state_path is None:
        ...
        try:
            ...
            logger.error(f"Error occurred when trying to resume training: {e}")
            raise
    return resume_state
...
def train_pipeline(root_path):
    ...
    try:
        ...
        logger.error(f"Error occurred when creating dataloaders: {e}")
        raise
